...
MY_SVC_APP_ConnHandleNotEvt_t MY_SVCHandleNotification;
  ...
  case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      MY_SVCHandleNotification.EvtOpcode = MY_SVC_DISCON_HANDLE_EVT;
      MY_SVCHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      MY_SVC_APP_EvtRx(&MY_SVCHandleNotification);
                                      ...
                                      uint16_t Supervision_Timeout)
{
  ...
  MY_SVCHandleNotification.EvtOpcode = MY_SVC_CONN_HANDLE_EVT;
  MY_SVCHandleNotification.ConnectionHandle = Connection_Handle;
  MY_SVC_APP_EvtRx(&MY_SVCHandleNotification);
